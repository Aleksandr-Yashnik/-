public class StringPractice {
    public static void main(String[] args) {
        ...
        String str4 = "Java";
        String replacedStr = str4.replace("a","D");
        ...
        String replacedAndLower = str11.replace("Fun","Awesom").toLowerCase();
        ...
        String replacedStr14 = str14.concat("fun").replace("fan","Awesom");
